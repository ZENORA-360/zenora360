...
const GOLD_COLORS = [
  "hsla(43, 100%, 55%, ",   // bright gold
  "hsla(36, 100%, 50%, ",   // deep gold
  "hsla(48, 100%, 65%, ",   // light gold
  "hsla(30, 90%, 45%, ",    // amber
  "hsla(50, 100%, 70%, ",   // pale gold
  "hsla(40, 95%, 60%, ",    // warm gold
];
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      for (let i = particles.length - 1; i >= 0; i--) {
        ...
        // Smooth fade: appear quickly, fade slowly
      ...
      if (mouseRef.current.active) {
        ...
        glow.addColorStop(0, "hsla(43, 100%, 55%, 0.08)");
